...
git_wt::usage() {
  ...
  git_wt::err "  a [<provider>] <feature> [<args...>]"
  git_wt::err "    providers: claude, cursorcli, opencode, codex"
  git_wt::err "    example: git-wt a claude my-feature --model opus"
  git_wt::err "  e <feature>"
  git_wt::err "  ca [<provider>] <feature> [<args...>]"
  git_wt::err "    create and open with AI"
  git_wt::err "    example: git-wt ca claude my-feature --model opus"
