...
git_wt::usage() {
  ...
  git_wt::err "  a [--ai <provider>] <feature> [<args...>]"
  git_wt::err "    providers: claude, cursorcli, opencode, codex"
  git_wt::err "    example: git-wt a --ai claude my-feature --model opus"
  git_wt::err "  e <feature>"
  git_wt::err "  ca [--ai <provider>] <feature> [<args...>]"
  git_wt::err "    create and open with AI"
  git_wt::err "    example: git-wt ca --ai claude my-feature --model opus"
  git_wt::err "  cs <feature> | ce <feature>"
